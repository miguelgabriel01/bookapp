...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'number' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'number' => 'Lorem ips',
                'created' => '2020-02-29 20:16:48',
                'modified' => '2020-02-29 20:16:48',
            ],
        ];
        parent::init();
    }
